...
public static class MessageCatalog
{
    private static readonly IReadOnlyDictionary<MessageCode, string> Messages =
        new Dictionary<MessageCode, string>
        {
            ...
            [MessageCode.AccountTypeCustomerTypeNotAllowed] = "The selected account type does not allow this customer type.",
            [MessageCode.AccountRefererCountInsufficient] = "The selected account type requires more referrers.",
            [MessageCode.AccountRefererSelectionInvalid] = "The referrer selection contains a blank or duplicate NRC.",
            [MessageCode.AccountRefererMustOwnAccount] = "Each referrer must already own an account at this bank.",
